...
export const internetOrWebsiteOrLinkDownErrorTitle = (websiteName: string) =>
  `${internetOrWebsiteDownErrorTitle(
    websiteName
  )} Also make sure that the external ${websiteName} link is correct and leads to the anime's page.`;
