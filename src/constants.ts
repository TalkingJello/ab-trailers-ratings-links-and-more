...
export const internetOrWebsiteDownErrorTitle = (websiteName: string) =>
  `Make sure you're connected to the internet and that ${websiteName} is not down. Also make sure that the external ${websiteName} link is correct and leads to the anime's page.`;
